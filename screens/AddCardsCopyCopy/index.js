...
const AlertCopy = ({
  ...
  return <View style={styles.container}>
    ...
    }}></ImageBackground><View style={styles.ygyRdaAL}><TextInput style={styles.BrTWDNKg}></TextInput></View><Text style={styles.pjBrMQQp}>My Cards on Secured Stripe</Text><TextInput style={styles.cdenuaLQ} placeholder="" placeholderTextColor="#000080"></TextInput><Pressable onPress={{}}><View style={styles.fTJeMZlW}></View></Pressable><Pressable onPress={() => navigation.navigate("   My Cards on Secured StripeCopy")}><Text style={styles.fJoqjXRC}>Edit Card</Text></Pressable><Pressable onPress={{}}><View style={styles.pIXrLGHG}></View></Pressable><Pressable onPress={{}}><Text style={styles.LcFABMTh}>Linked Cards</Text></Pressable><Pressable onPress={() => navigation.navigate("AlertCopy")}><View style={styles.zPueiiWI}><Pressable onPress={{}}><Text style={styles.HmfkrKzB}>Add Card</Text></Pressable></View></Pressable><View style={styles.trovmrGm}></View><View style={styles.ziydllCe}><TextInput style={styles.KxfVVCjZ} placeholder="4Digits" placeholderTextColor="#000080"></TextInput></View><Text style={styles.BfODlGuQ}>Card </Text><View style={styles.QQiWeLkS}><TextInput style={styles.xfnLnWms} placeholder="$1,200" placeholderTextColor="#000080"></TextInput></View><Text style={styles.BYDhCXlm}>Earns</Text><View style={styles.SmrjiOKd}><TextInput style={styles.opzashvK} placeholder="20%" placeholderTextColor="#000080"></TextInput></View><Text style={styles.DOEJawKu}>Gains</Text><View style={styles.JyPArBpx}></View><View style={styles.VTHScAMz}></View><View style={styles.jSOZkSiS}></View><View style={styles.MQKxhMrw}></View><View style={styles.KjqoPhDB}><TextInput style={styles.zxOaUDzm}></TextInput></View><View style={styles.ZbmDaJQb}><TextInput style={styles.ShEpssCW}></TextInput></View><View style={styles.UCTzakZO}><TextInput style={styles.YGFQTRzU}></TextInput></View><View style={styles.PQPcJMWM}><TextInput style={styles.rcVXghTd}></TextInput></View><View style={styles.dZGdXeRn}><TextInput style={styles.qVPOQdDF}></TextInput></View><View style={styles.JfaIGbLK}><TextInput style={styles.gTPxmNSQ}></TextInput></View><View style={styles.GfCMsrAj}><TextInput style={styles.tPATrAuW}></TextInput></View><View style={styles.PAXgUDOM}><TextInput style={styles.DoXfpMjP}></TextInput></View><View style={styles.jMQWainh}><TextInput style={styles.WsyrbMVA}></TextInput></View><View style={styles.gQJGqypC}><TextInput style={styles.BXUHzgSZ}></TextInput></View><View style={styles.gNbHUCJq}><TextInput style={styles.vFebmwQq}></TextInput></View><View style={styles.MEcrIiPp}><TextInput style={styles.uNkjgIAj}></TextInput></View><View style={styles.dDztawJJ}><TextInput style={styles.jHmtaPzn}></TextInput></View></View>;
};
