...
const Untitled5 = () => {
  return <View style={_styles.YtzVXevu}>
      <Text style={_styles.CrzQFvlg}>Username</Text><Text style={_styles.TYmMJduQ}>Password</Text><TextInput style={_styles.hXPQrlHV}></TextInput><TextInput style={_styles.MEuJKrmD}></TextInput><Text style={_styles.RitWcLRQ}>Forgot Password ?</Text><Text style={_styles.IYjybLsl}>Forgot Username?</Text><ImageBackground style={_styles.hvRWmtHA} source={{
