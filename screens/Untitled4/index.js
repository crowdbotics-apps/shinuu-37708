...
const Untitled4 = ({
  ...
  return <View style={_styles.uLPMQMwC}>
    ...
    }} resizeMode="cover"></ImageBackground><Text style={_styles.TytbkbFY}>Sign up fand watch your rewards money grow </Text><Text style={_styles.HJLqANJF}>Log In with </Text><View style={_styles.qWhZdUMf}><Text style={_styles.axEmJvwf}>Apple Pay</Text></View><View style={_styles.xUylfcsN}><Text style={_styles.QgYfyKZj}>Google Pay</Text></View><View style={_styles.gEQMZthr}><Text style={_styles.XGSlHfrL}>Amazon Pay</Text></View><View style={_styles.Aubfbrgd}><Text style={_styles.gSjwDmWM}>Happy Hippo</Text></View><View style={_styles.nhHiMelC}><Text style={_styles.pLLaFnqB}>New Sign Up as </Text></View><Text style={_styles.aspUsHAz}>Happy Hippo</Text><Text style={_styles.BZyXToGA}>Or with </Text></View>;
};
