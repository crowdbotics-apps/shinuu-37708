...
Log In with </Text><Pressable onPress={{}}><Text style={_styles.auuozdKT}>Gmail </Text></Pressable><Pressable onPress={{}}><Text style={_styles.NgZfsgkc}>Facebook</Text></Pressable><Text style={_styles.DNiRTuxy}>Email</Text><TextInput style={_styles.BbKjlvWT}></TextInput></View>;
};
