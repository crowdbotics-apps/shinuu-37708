...
const Untitled4 = ({
  ...
  return <View style={_styles.uLPMQMwC}>
    ...
    }} resizeMode="cover"></ImageBackground><Text style={_styles.TytbkbFY}>Sign up for your e-Wallet and watch your rewards money grow </Text><Text style={_styles.HJLqANJF}>OR
Log In with </Text><Pressable onPress={() => navigation.navigate("Untitled3")}><View style={_styles.PdXKwVTJ}><Text style={_styles.vKvXxwaz}>Submit</Text></View></Pressable><Pressable onPress={() => navigation.navigate("GooglePayCopy")}><View style={_styles.PqqvFAdj}></View></Pressable><Pressable onPress={() => navigation.navigate("GooglePayCopy")}><Text style={_styles.oOzvdTUe}>Apple Pay</Text></Pressable><Pressable onPress={() => navigation.navigate("Untitled5")}><View style={_styles.FyvxJWBs}></View></Pressable><Pressable onPress={() => navigation.navigate("Untitled5")}><Text style={_styles.DXtfoAeH}>Google Pay</Text></Pressable><Pressable onPress={{}}><View style={_styles.TcPmoZyN}></View></Pressable><Pressable onPress={() => navigation.navigate(" Apple PayCopy")}><Text style={_styles.ZjxOUWAM}>Amazon Pay</Text></Pressable><Pressable onPress={() => navigation.navigate("GmailLogInCopy")}><View style={_styles.rECHSPSD}></View></Pressable><Pressable onPress={() => navigation.navigate("GmailLogInCopy")}><Text style={_styles.SjvKckun}>Email</Text></Pressable><TextInput style={_styles.PIOmdeUl} placeholder="   Email Log In"></TextInput><TextInput style={_styles.YAzTtArO} placeholder="   Password"></TextInput></View>;
};
