...
Log In with </Text><Pressable onPress={() => navigation.navigate("Untitled2")}><View style={_styles.PdXKwVTJ}><Text style={_styles.vKvXxwaz}>Submit</Text></View></Pressable><View style={_styles.PqqvFAdj}></View><Text style={_styles.oOzvdTUe}>Apple Pay</Text><View style={_styles.FyvxJWBs}></View><Text style={_styles.DXtfoAeH}>Google Pay</Text><View style={_styles.TcPmoZyN}></View><Text style={_styles.ZjxOUWAM}>Amazon Pay</Text><View style={_styles.rECHSPSD}></View><Text style={_styles.SjvKckun}>Email</Text></View>;
};
