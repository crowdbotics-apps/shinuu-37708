...
const Untitled4 = () => {
  return <View style={_styles.uLPMQMwC}>
    ...
    }} resizeMode="cover"></ImageBackground><Text style={_styles.TytbkbFY}>Sign up for your e-Wallet and watch your rewards money grow </Text><TextInput style={_styles.BlZoDBFm} spellCheck={true} enablesReturnKeyAutomatically={true}></TextInput><Text style={_styles.GrQcKnuv}>Email</Text><Text style={_styles.EYPkjfvZ}>Password</Text><Pressable onPress={{}}><Text style={_styles.zwFQKzks}>Create Account</Text></Pressable><Text style={_styles.HJLqANJF}>OR
Log In with </Text><Pressable onPress={{}}><Text style={_styles.auuozdKT}>Google Pay</Text></Pressable><Pressable onPress={{}}><Text style={_styles.NgZfsgkc}>Amazon Pay</Text></Pressable><Text style={_styles.DNiRTuxy}>Email</Text><TextInput style={_styles.BbKjlvWT}></TextInput><Text style={_styles.VuoWHBVN}>Apple Pay</Text></View>;
};
