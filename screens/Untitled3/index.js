...
const Untitled3 = ({
  ...
  return <View style={_styles.urOKQkAj}>
      <Text style={_styles.erDCMtXV}>Build Your Profile</Text><ImageBackground style={_styles.gwgsFetX} source={{
