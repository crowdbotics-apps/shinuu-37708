...
const Untitled3 = () => {
  return <View style={_styles.urOKQkAj}>
    ...
    }}></ImageBackground><View style={_styles.XlUyworz}></View><Text style={_styles.hGYMNaFg}>Guard Your Data</Text><View style={_styles.CAxDllGI}></View><Text style={_styles.XTwRcVsu}>Store Data Safely</Text><View style={_styles.ERZYTaSb}></View><Text style={_styles.FxfUQwtP}>Add Cards</Text></View>;
};
