...
const Untitled3 = () => {
  return <View style={_styles.urOKQkAj}>
    ...
    }}></ImageBackground><View style={_styles.XlUyworz}></View><Text style={_styles.hGYMNaFg}>Guard your data</Text><View style={_styles.CAxDllGI}></View><Text style={_styles.XTwRcVsu}>Enable cloud restore</Text><View style={_styles.ERZYTaSb}></View><Text style={_styles.FxfUQwtP}>Add Cards</Text></View>;
};
