...
const Untitled3 = ({
  ...
  return <View style={_styles.urOKQkAj}>
      <Text style={_styles.erDCMtXV}>Manage Your Card</Text><ImageBackground style={_styles.gwgsFetX} source={{
    ...
    }}></ImageBackground><View style={_styles.XlUyworz}></View><Text style={_styles.hGYMNaFg}>Guard Your Data</Text><View style={_styles.CAxDllGI}></View><Text style={_styles.XTwRcVsu}>Store Data Safely</Text><Pressable onPress={() => navigation.navigate("billingPreferences")}><View style={_styles.ERZYTaSb}></View></Pressable><Pressable onPress={() => navigation.navigate("billingPreferences")}><Text style={_styles.FxfUQwtP}>Add Cards</Text></Pressable><Text style={_styles.iUInZFrj}>Privacy Policy</Text></View>;
};
