...
const Untitled3 = () => {
  return <View style={_styles.urOKQkAj}>
    ...
    }}></ImageBackground><Text style={_styles.erDCMtXV}>Manage Your Card</Text><Text style={_styles.nXeUKlNe}>Guard your cards with Bio-Metric access or permission digits</Text></View>;
};
