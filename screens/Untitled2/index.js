...
const Untitled2 = () => {
  return <View style={_styles.MmLgxBaj}>
      <Text style={_styles.wcvRUhsI}>Privacy Policy</Text><Text style={_styles.bCIXkceR}>First Name</Text><Text style={_styles.hJvvlKhC}>Last Name</Text><Text style={_styles.idmZdeQd}>Date of Birth</Text><ImageBackground style={_styles.DhfeNDWs} source={{
    ...
    }}></ImageBackground><Text style={_styles.NRwZkDfd}>Create Your Profile</Text></View>;
};
