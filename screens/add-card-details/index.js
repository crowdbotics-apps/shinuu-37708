...
const AddCardDetailsScreen = params => {
  ...
  return <SafeAreaView style={styles.container}>
    ...
    <ImageBackground style={styles.gzzlpZBp} source={{
    ...
    }}></ImageBackground><View style={styles.qwASUPDs}><View style={styles.HoRznzhG}><TextInput style={styles.VyaGCFyu} placeholder="  Zip Code" placeholderTextColor="#9B9B9B"></TextInput></View><View style={styles.xxFIiGYw}><TextInput style={styles.eSfrtTKm} placeholder="   Country" placeholderTextColor="#9B9B9B"></TextInput></View></View><View style={styles.vaarUwRM}><View style={styles.QTrJEbXp}><TextInput style={styles.WRVoXzHi} placeholder="Card Expiration" placeholderTextColor="#9B9B9B"></TextInput></View><View style={styles.nmurezAv}><TextInput style={styles.FUyteLNj} placeholder="Enter CVV" placeholderTextColor="#9B9B9B"></TextInput></View></View><View style={styles.KnPwGEcr}></View><Text style={styles.oqZkrcqY}>Update</Text></SafeAreaView>;
};
