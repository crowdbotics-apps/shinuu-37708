...
const Untitled5 = () => {
  return <View style={_styles.YtzVXevu}>
      <Text style={_styles.CrzQFvlg}>Gmail</Text><Text style={_styles.TYmMJduQ}>Password</Text><TextInput style={_styles.hXPQrlHV}></TextInput><TextInput style={_styles.MEuJKrmD}></TextInput><ImageBackground style={_styles.GfiFEqFk} source={{
